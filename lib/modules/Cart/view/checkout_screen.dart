                                                ...
                                                child:
                                                    profileController
                                                        ...
                                                        : Row(
                                                            ...
                                                            (index) {
                                                              return Obx(() => InkWell(
                                                                  onTap: getAvaliple(index, controller.dateDay2.value, profileController.shippingTimes) == false
                                                                      ? null
                                                                      : () {
                                                                          controller
                                                                              .selectTime(profileController.shippingTimes[index]);
                                                                        },
                                                                  child: Padding(
                                                                      ...
                                                                      child: Container(
                                                                        ...
                                                                        height:
                                                                            55.h,
                                                                        decoration: BoxDecoration(
                                                                            color: getAvaliple(index, controller.dateDay2.value, profileController.shippingTimes) == false
                                                                                ? Colors.grey
                                                                                : controller.selectedTime.value == profileController.shippingTimes[index]
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            getPeriod(profileController.shippingTimes[index]),
                                                                            style: Style.cairo.copyWith(
                                                                                color: getAvaliple(index, controller.dateDay2.value, profileController.shippingTimes) == false
                                                                                    ? Colors.white
                                                                                    : controller.selectedTime.value == profileController.shippingTimes[index]
