...
bool getAvaliple(int index, String day, List<String> shippingTimes) {
  String time = shippingTimes[index].split("-").last;
                ...
                itemBuilder: (context, index) {
                  return Padding(
                      ...
                      child: ListTile(
                          ...
                          onTap:
                              controller.addressModel.data![index].isDefault == 1
                                  ? null
                                  : () async {
